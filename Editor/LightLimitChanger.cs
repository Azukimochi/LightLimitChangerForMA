    ...
    public sealed class LightLimitChanger : EditorWindow
    {
        ...
        private void ShowGeneratorMenu()
        {
            ...
            using (new Utils.DisabledScope(EditorApplication.isPlaying))
            {
                ...
                {
                    param.AllowColorTempControl = EditorGUILayout.Toggle(Localization.G("Allow Color Temperature Ctrl(Exp)", "You can enable the Color Temperature adjustment function"), param.AllowColorTempControl);
